<template>
  <header>
    <!-- Nav position -->
    <nav class="flex h-16 justify-between border border-black-600 items-center bg-white text-gray-800 px-5 py-3 text-sm fixed top-0 left-0 right-0 z-10">
      <div class="text-md flex items-center">
        <p class="px-4 text-lg w-1/3"><svg class="style-scope ytd-topbar-logo-renderer" viewbox="0 0 200 60"
      ...
      <div class="text-md flex items-center">
        <a href="#">
          <svg class="fill-current mx-2 h-6 w-6 cursor-pointer text-gray-600" fill="none" viewbox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <a class="bg-orange-900 rounded-full text-white w-8 h-8 flex items-center justify-center text-lg" href="#">S</a>
      </div>
    </nav>
    <!-- Buttons -->
  ...
  <main class="h-screen mt-10 ml-0 px-12 py-6 xl:px-40">
    <div class="flex flex-col border-b border-gray-300">
      <div class="flex flex-row flex-wrap">
        <div class="mr-1 my-2"><img src="http://www.placecage.com/210/118">
        ...
        <div class="mr-1 my-2"><img src="http://www.fillmurray.com/210/118">
          <p class="text-sm py-1">Some title for the video</p>
          <p class="text-xs text-gray-600">Some creator</p>
          <p class="text-xs text-gray-600">458K views &bull; 7 months ago</p>
        </div>
        <div class="mr-1 my-2"><img src="http://www.stevensegallery.com/210/118">
          <p class="text-sm py-1">Some title for the video</p>
          <p class="text-xs text-gray-600">Some creator</p>
          <p class="text-xs text-gray-600">458K views &bull; 7 months ago</p>
        </div>
